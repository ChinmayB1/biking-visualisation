...
mapboxgl.accessToken = 'pk.eyJ1IjoiY2IxMDExIiwiYSI6ImNtYXFhNW1veTA4MGgya29sOTl1eGt1ZHcifQ.iPo_3AGEsbA40XK67mCs-A';

// Initialize the map
const map = new mapboxgl.Map({
    container: 'map', // ID of the div where the map will render
    style: 'mapbox://styles/mapbox/streets-v12', // Map style
    center: [-71.0589, 42.3601], // Boston center coordinates [longitude, latitude]
    zoom: 12.5, // Initial zoom level
    minZoom: 5, // Minimum allowed zoom
    maxZoom: 18, // Maximum allowed zoom
    attributionControl: true,
    padding: {top: 20, bottom: 20, left: 20, right: 20}, // Padding to ensure markers are visible
});
